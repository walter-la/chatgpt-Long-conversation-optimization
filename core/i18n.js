...
const I18N_MESSAGES = {
  en: {
    ...
    "toolbar.toggleMenuAria": "Toggle toolkit menu",
    "toolbar.collapseMenuAria": "Collapse toolkit menu",
    "toolbar.expandMenuAria": "Expand toolkit menu",
    ...
    "status.promptUpdateDone": "Prompt updated.",
    ...
    "prompt.shortcutEmpty": "No prompts found.",
    ...
    "prompt.update": "Save Changes",
    "prompt.cancel": "Cancel",
    "prompt.count": "{visible} / {total} prompts",
    "prompt.importJson": "Import JSON",
    "prompt.exportJson": "Export JSON",
    "prompt.delete": "Delete",
    "prompt.edit": "Edit",
    "prompt.copy": "Copy",
    "prompt.itemMetaWithTime": "{category} · {time} · Click to edit",
    "prompt.itemMetaNoTime": "{category} · Click to edit",
  ...
  "zh-CN": {
    ...
    "toolbar.toggleMenuAria": "切换功能选单",
    "toolbar.collapseMenuAria": "收起功能选单",
    "toolbar.expandMenuAria": "展开功能选单",
    ...
    "prompt.shortcutEmpty": "没有找到相应的 Prompt。",
    ...
    "prompt.edit": "编辑",
    "prompt.copy": "复制",
    "prompt.itemMetaWithTime": "{category} · {time} · 单击编辑",
    "prompt.itemMetaNoTime": "{category} · 单击编辑",
